...
const HTML_FOLDER = "public/pages";  // folder with your HTML files
...
const MAX_PREVIEW_CHARS = 150;  // Number of characters to show for a given search result
const OUTPUT_INDEX = "themes/netdava/js/index/lunr_index.js";  // Index file
...
function readHtml(root, file, fileId) {
    ...
    var content = $(".ui.main.text.container.vertical.segment").text().trim();
